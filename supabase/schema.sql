...
create index if not exists appointments_date_idx     on public.appointments ((data->>'date'));
create index if not exists appointments_status_idx   on public.appointments ((data->>'status'));
